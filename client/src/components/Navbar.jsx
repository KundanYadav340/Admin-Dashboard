...
import { useTheme, Button, Box, Typography, AppBar, IconButton, InputBase, Toolbar, Menu, MenuItem} from '@mui/material';
        ...
        <Toolbar sx={{justifyContent:"space-between"}}>
            ...
            <FlexBetween gap="1.5rem">
                ...
                <FlexBetween>
                    ...
                    <Menu anchorEl={anchorEl} open={isOpen} onClose={handleClose} anchorOrigin={{verical:"bottom", horizontal:"center"}}>
